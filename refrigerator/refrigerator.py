...
def create_refrigerator(
    ...
    download_python_script = os.path.join(downloaders_dir, "download_python.ps1")
    download_pip_script = os.path.join(downloaders_dir, "download_pip.ps1")
    download_deps_script = os.path.join(downloaders_dir, "download_deps.ps1")
    downloaders_dir = os.path.join(target_directory, "downloaders")
    os.mkdir(downloaders_dir)
    for script in [download_python_script, download_pip_script, download_deps_script]:
